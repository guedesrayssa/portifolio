...
export const copy = {
  pt: {
    ...
    library: {
      ...
      title: "Biblioteca",
      controls: "Controles da biblioteca",
      previous: "Voltar um item",
      next: "Avançar um item",
      rail: "Arquivo horizontal de projetos",
    ...
    footer: {
      build: "Projetado e construído com intenção · São Paulo · MMXXVI",
  ...
  en: {
    ...
    library: {
      ...
      next: "Next item",
      rail: "Horizontal project archive",
    ...
    footer: {
      build: "Designed and built with intention · São Paulo · MMXXVI",
